...
export class HLSPonyfillHTMLVideoElement extends HTMLVideoElement {
    /**
    ...
    static install(forced) {
        ...
        const Hls = HLSPonyfillHTMLVideoElement.getHlsConstructor();
        if (!Hls.isSupported()) {
            return false;
        }
        customElements.define('hls-ponyfill', HLSPonyfillHTMLVideoElement, {
            extends: 'video',
        });
        return true;
    }
